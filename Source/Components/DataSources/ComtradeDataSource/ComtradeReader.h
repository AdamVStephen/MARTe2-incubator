/**
 * @file ComtradeReader.h
 * @brief Header file for class ComtradeReader
 * @date 11/08/2017
 * @author Andre Neto
 *
 ...
 * @details This header file contains the declaration of the class ComtradeReader
 ...
 *     XAxisSignal = "Time" //Compulsory if Interpolate = "yes" and none of the signals interacting with this ComtradeReader has Frequency > 0. Name of the signal containing the independent variable to generate the interpolation samples.
 *     InterpolationPeriod = 1000 //Compulsory if Interpolate = "yes" and none of the signals interacting with this ComtradeReader has Frequency > 0. InterpolatedXAxisSignal += InterpolationPeriod. It will be read as an uint64.
 ...
 * </pre>
 */
class ComtradeReader: public DataSourceI, public MessageI {
