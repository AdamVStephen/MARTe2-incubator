/**
 * @file ComtradeWriter.h
 * @brief Header file for class ComtradeWriter
 * @date 26/02/2022
 * @author Adam Stephen
 *
 ...
 * @details This header file contains the declaration of the class ComtradeWriter
 ...
 * </pre>
 */
typedef enum comtradedatasource_rotatesuffix_policy {
	ComtradeRotateSuffixBasicIndex = 1,
	ComtradeRotateSuffixZeroPaddedIndex = 2,
	ComtradeRotateSuffixEpochTimestamp = 3
} ComtradeWriterRotateSuffixPolicy;
	
class ComtradeWriter: public DataSourceI, public MessageI {
public:
    ...
    /**
     * @brief File rotation : close the current file and open a new one.
     * @param[in] filenameIn the name of the file to be opened.
     * @return ErrorManagement::NoError if the file can be successfully opened.
     */
    ErrorManagement::ErrorType RotateFile(ComtradeWriterRotateSuffixPolicy suffixPolicy);
    ...
    /**
     * @brief Gets the max number of lines before file rotation
     * @return the max number of lines written to the file before file rotation..
     */
    uint64 GetMaxNumberOfLines() const;

     /**
     * @brief Gets the current number of lines sent to the file
     * @return the number of lines written to the file.
     */
    uint64 GetCurrentNumberOfLines() const;
...
private:
    ...
    /**
     * Comtrade files have a max number of lines before file rotation
     */
    uint64 maxNumberOfLinesPerFile;

     /**
     * Current number of lines written
     */
    uint64 currentNumberOfLines;

    /**
     * RotateFile suffix policy
     */
     ComtradeWriterRotateSuffixPolicy suffixPolicy;
